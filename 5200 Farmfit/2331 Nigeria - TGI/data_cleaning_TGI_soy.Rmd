...
pi_filename <- "pi_2023_TGI_soy.xlsx"
data_filename <- "481840250_TGI_soy_raw_data.xlsx"
survey_filename <- "survey_TGI_soy.xlsx"
data_delivery <- "2023_TGI_anom_soy.xlsx"
...
##Measurement unit for production
  ...
  mutate(cal_focus_measurement_prod = ifelse(f_focus_measurement_prod == "100 kg bag", 100, cal_focus_measurement_prod)) 
...
##Measurement unit for sales focus crop
  ...
  mutate(cal_focus_measurement_sold = ifelse(f_focus_measurement_sold == "100 kg bag", 
...
for (j in multiple_mc) {
  ...
  if (j == "hh_loan_multiple_agri_use") {
    next
  }
  ...
  if (j == "hh_loan_mulitple_agri_purpose") {
    next
  }
  if (j == "cs_negative_recommendation") {
    next
  }
...
write.xlsx(pi_info, file="pi_2023_TGI_soy.xlsx")
...
write.xlsx (productivity, file = "productivity_check_soy.xlsx", overwrite = TRUE)
```
