...
##  ---- define filenames ----
cleaned_data = "2021_RGL_anom_rice_intermediate.xlsx"
survey_filename <- "survey_rgl_rice.xlsx"
raw_data <- "24092021_rgl_rice_raw_data.xlsx"
data_delivery <- "2021_RGL_anom_rice.xlsx"
...
#Raw data
#Data_raw <- read_excel(
 # here::here("Volumes/GoogleDrive/My Drive/04_data_analytics/RGL", paste0(raw_data))) %>%
...
write.xlsx (sets, file = data_delivery)
