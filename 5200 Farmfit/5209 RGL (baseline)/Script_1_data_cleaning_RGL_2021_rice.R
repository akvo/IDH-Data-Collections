...
setwd("/Users/ineslesire/Documents/GitHub/Analytics-Guild/1. Descriptive Analytics/IDH/5200 Farmfit/5209 RGL (baseline)")


##  ---- describe datafiles ----
data_filename <- "24092021_rgl_rice_raw_data.xlsx"
survey_filename <- "survey_rgl_rice.xlsx"
output_filename <- "2021_RGL_anom_rice_intermediate.xlsx"
pi_filename <- "pi_2021_RGL_rice.xlsx"
...
Data <- Data %>%
  select(-contains("alltimeframes"), -contains("part_1_total_cost"),-contains("part_2_total_cost"), -contains("cost_timeperiod"))
