...
```{r}
data_filename <- "DATA_ANALYSIS-650580046-Ghana-Tamanaa-Rice.xlsx"
survey_filename <- "SURVEY_FORM-650580046-Ghana-Tamanaa-Rice.xlsx"
```
...
Data <- Data %>%
  mutate(f_unit_land=ifelse(f_unit_land== "poles", "acres", f_unit_land))
```
#Adjust farm size
```{r}
...
Data <- Data %>%
  mutate(
    #prod
    f_focus_measurement_prod = ifelse(identifier %in% c("xv9rfeub27p4", "cahtnkvjx9gp"), "100 kgs bags", f_focus_measurement_prod),
    #sold
...
Data <- Data %>%
  mutate(f_focus_quant_sold = 
           ifelse(f_focus_quant_sold == 9999, NA,
...
Data <- Data %>%
  mutate(f_focus_price = ifelse(identifier == "dsgatgwt65s8", f_focus_price * 100, f_focus_price))
...
```{r}
Data <- Data %>%
  mutate(f_size = ifelse(identifier == "h3ytcty2udcj", 35, 
                         ifelse(identifier == "a942a17s522p", 20,
                                ifelse(identifier == "68rghc83xths", 25,
                                       ifelse(identifier == "qgf8qhty3yc1", 24,
                                              ifelse(identifier == "yj0unx4u14qq", 20,
                         f_size))))),
         f_focus_crop_size = ifelse(identifier == "jgphm2qag1hj", 6,
                                    ifelse(identifier == "x5m6ehtd9bcq", 6,
                                           ifelse(identifier == "u7qsqqs5euyk", 6,
                                                  ifelse(identifier == "h3ytcty2udcj", 15,
                                                         ifelse(identifier == "4xxkncc7r8n4", 8,
                                                                ifelse(identifier == "wjfwaka2aqdk", 6,
                                                                      ifelse(identifier == "nrr34jcug41w", 6,
                                                                           ifelse(identifier == "ud3a7tk2t28c", 7,
                                    f_focus_crop_size)))))))))


Data <- Data %>%
  mutate(f_focus_quant_prod = ifelse(identifier == "jgphm2qag1hj", 75,
                                    ifelse(identifier == "06s7eup2n38a", 90,
                                           ifelse(identifier == "x5m6ehtd9bcq", 72,
                                                  ifelse(identifier == "u7qsqqs5euyk", 102,
                                                         ifelse(identifier == "h3ytcty2udcj", 100,
                                                                ifelse(identifier == "4xxkncc7r8n4", 102,
                                    f_focus_quant_prod)))))),
         f_focus_quant_sold = ifelse(identifier == "jgphm2qag1hj", 60,
                                    ifelse(identifier == "06s7eup2n38a", 65,
                                                  ifelse(identifier == "u7qsqqs5euyk", 87,
                                                         ifelse(identifier == "h3ytcty2udcj", 100,
                                                                ifelse(identifier == "4xxkncc7r8n4", 85,
                                    f_focus_quant_sold))))),
         f_focus_own_consumption = ifelse(identifier == "06s7eup2n38a", 10,
                                          ifelse(identifier == "x5m6ehtd9bcq", 10,
                                                  ifelse(identifier == "u7qsqqs5euyk", 9,
                                                         ifelse(identifier == "eq6y9qrvr0jv", 10,
...
#    cal_labour_cost_season_1_dry = ifelse(f_focus_labour_rev_timeperiod == "season 1 june  dry season", cal_labour_cost, NA),
    cal_labour_cost_season_1 = ifelse(f_focus_labour_rev_timeperiod == "season 1 june  wet season", cal_labour_cost, NA),
...
Data <- Data %>%
  ...
  mutate(
    cal_inputs_costs_season_1 = ifelse(f_focus_inputs_rev_timeperiod == "season 1 the whole years", cal_inputs_costs, NA))
